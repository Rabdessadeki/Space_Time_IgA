...
#define MOD_A4VHDUE1QG40_WRAPPER

#include "mod_a4vhdue1qg40_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_a4vhdue1qg40_methods[] = {
    {
...
static struct PyModuleDef mod_a4vhdue1qg40_module = {
    ...
    0,
    mod_a4vhdue1qg40_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_a4vhdue1qg40(void)
{
    PyObject* mod;
    static void* Pymod_a4vhdue1qg40_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_a4vhdue1qg40_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_a4vhdue1qg40_API, "mod_a4vhdue1qg40._C_API", NULL);
