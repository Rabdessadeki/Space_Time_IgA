...
#define MOD_C3HXHIZYQTRO_WRAPPER

#include "mod_c3hxhizyqtro_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_c3hxhizyqtro_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_c3hxhizyqtro_module = {
    ...
    0,
    mod_c3hxhizyqtro_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_c3hxhizyqtro(void)
{
    PyObject* mod;
    static void* Pymod_c3hxhizyqtro_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_c3hxhizyqtro_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_c3hxhizyqtro_API, "mod_c3hxhizyqtro._C_API", NULL);
