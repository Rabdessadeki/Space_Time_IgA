...
#define MOD_8JSA8C77K6X0_WRAPPER

#include "mod_8jsa8c77k6x0_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_8jsa8c77k6x0_methods[] = {
    {
...
static struct PyModuleDef mod_8jsa8c77k6x0_module = {
    ...
    0,
    mod_8jsa8c77k6x0_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_8jsa8c77k6x0(void)
{
    PyObject* mod;
    static void* Pymod_8jsa8c77k6x0_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_8jsa8c77k6x0_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_8jsa8c77k6x0_API, "mod_8jsa8c77k6x0._C_API", NULL);
