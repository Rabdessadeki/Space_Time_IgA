...
#define MOD_E1WGQ7XAF0R5_WRAPPER

#include "mod_e1wgq7xaf0r5_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_e1wgq7xaf0r5_methods[] = {
    {
...
static struct PyModuleDef mod_e1wgq7xaf0r5_module = {
    ...
    0,
    mod_e1wgq7xaf0r5_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_e1wgq7xaf0r5(void)
{
    PyObject* mod;
    static void* Pymod_e1wgq7xaf0r5_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_e1wgq7xaf0r5_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_e1wgq7xaf0r5_API, "mod_e1wgq7xaf0r5._C_API", NULL);
