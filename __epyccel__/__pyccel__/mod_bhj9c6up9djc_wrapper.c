...
#define MOD_BHJ9C6UP9DJC_WRAPPER

#include "mod_bhj9c6up9djc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_bhj9c6up9djc_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_bhj9c6up9djc_module = {
    ...
    0,
    mod_bhj9c6up9djc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_bhj9c6up9djc(void)
{
    PyObject* mod;
    static void* Pymod_bhj9c6up9djc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_bhj9c6up9djc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_bhj9c6up9djc_API, "mod_bhj9c6up9djc._C_API", NULL);
