...
#define MOD_5GIVAVRB8S0V_WRAPPER

#include "mod_5givavrb8s0v_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_5givavrb8s0v_methods[] = {
    {
...
static struct PyModuleDef mod_5givavrb8s0v_module = {
    ...
    0,
    mod_5givavrb8s0v_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_5givavrb8s0v(void)
{
    PyObject* mod;
    static void* Pymod_5givavrb8s0v_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_5givavrb8s0v_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_5givavrb8s0v_API, "mod_5givavrb8s0v._C_API", NULL);
