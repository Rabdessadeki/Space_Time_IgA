...
#define MOD_OTY7ND1UCU5O_WRAPPER

#include "mod_oty7nd1ucu5o_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_oty7nd1ucu5o_methods[] = {
    {
...
static struct PyModuleDef mod_oty7nd1ucu5o_module = {
    ...
    0,
    mod_oty7nd1ucu5o_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_oty7nd1ucu5o(void)
{
    PyObject* mod;
    static void* Pymod_oty7nd1ucu5o_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_oty7nd1ucu5o_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_oty7nd1ucu5o_API, "mod_oty7nd1ucu5o._C_API", NULL);
