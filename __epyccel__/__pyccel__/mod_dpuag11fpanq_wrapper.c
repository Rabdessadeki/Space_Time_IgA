...
#define MOD_DPUAG11FPANQ_WRAPPER

#include "mod_dpuag11fpanq_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dpuag11fpanq_methods[] = {
    {
...
static struct PyModuleDef mod_dpuag11fpanq_module = {
    ...
    0,
    mod_dpuag11fpanq_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dpuag11fpanq(void)
{
    PyObject* mod;
    static void* Pymod_dpuag11fpanq_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dpuag11fpanq_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dpuag11fpanq_API, "mod_dpuag11fpanq._C_API", NULL);
