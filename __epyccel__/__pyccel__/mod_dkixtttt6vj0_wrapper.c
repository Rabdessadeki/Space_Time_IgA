...
#define MOD_DKIXTTTT6VJ0_WRAPPER

#include "mod_dkixtttt6vj0_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dkixtttt6vj0_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_dkixtttt6vj0_module = {
    ...
    0,
    mod_dkixtttt6vj0_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dkixtttt6vj0(void)
{
    PyObject* mod;
    static void* Pymod_dkixtttt6vj0_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dkixtttt6vj0_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dkixtttt6vj0_API, "mod_dkixtttt6vj0._C_API", NULL);
