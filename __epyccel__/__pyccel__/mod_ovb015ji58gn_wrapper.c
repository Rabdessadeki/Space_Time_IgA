...
#define MOD_OVB015JI58GN_WRAPPER

#include "mod_ovb015ji58gn_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ovb015ji58gn_methods[] = {
    {
...
static struct PyModuleDef mod_ovb015ji58gn_module = {
    ...
    0,
    mod_ovb015ji58gn_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ovb015ji58gn(void)
{
    PyObject* mod;
    static void* Pymod_ovb015ji58gn_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ovb015ji58gn_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ovb015ji58gn_API, "mod_ovb015ji58gn._C_API", NULL);
