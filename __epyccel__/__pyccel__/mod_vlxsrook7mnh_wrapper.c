...
#define MOD_VLXSROOK7MNH_WRAPPER

#include "mod_vlxsrook7mnh_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_vlxsrook7mnh_methods[] = {
    {
...
static struct PyModuleDef mod_vlxsrook7mnh_module = {
    ...
    0,
    mod_vlxsrook7mnh_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vlxsrook7mnh(void)
{
    PyObject* mod;
    static void* Pymod_vlxsrook7mnh_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_vlxsrook7mnh_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_vlxsrook7mnh_API, "mod_vlxsrook7mnh._C_API", NULL);
