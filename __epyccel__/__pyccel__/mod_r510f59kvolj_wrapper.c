...
#define MOD_R510F59KVOLJ_WRAPPER

#include "mod_r510f59kvolj_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_r510f59kvolj_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_r510f59kvolj_module = {
    ...
    0,
    mod_r510f59kvolj_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_r510f59kvolj(void)
{
    PyObject* mod;
    static void* Pymod_r510f59kvolj_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_r510f59kvolj_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_r510f59kvolj_API, "mod_r510f59kvolj._C_API", NULL);
