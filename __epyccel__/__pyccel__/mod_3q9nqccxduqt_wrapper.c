...
#define MOD_3Q9NQCCXDUQT_WRAPPER

#include "mod_3q9nqccxduqt_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_3q9nqccxduqt_methods[] = {
    {
...
static struct PyModuleDef mod_3q9nqccxduqt_module = {
    ...
    0,
    mod_3q9nqccxduqt_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_3q9nqccxduqt(void)
{
    PyObject* mod;
    static void* Pymod_3q9nqccxduqt_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_3q9nqccxduqt_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_3q9nqccxduqt_API, "mod_3q9nqccxduqt._C_API", NULL);
