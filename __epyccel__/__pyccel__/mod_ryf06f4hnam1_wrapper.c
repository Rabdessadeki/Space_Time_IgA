...
#define MOD_RYF06F4HNAM1_WRAPPER

#include "mod_ryf06f4hnam1_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ryf06f4hnam1_methods[] = {
    {
...
static struct PyModuleDef mod_ryf06f4hnam1_module = {
    ...
    0,
    mod_ryf06f4hnam1_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ryf06f4hnam1(void)
{
    PyObject* mod;
    static void* Pymod_ryf06f4hnam1_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ryf06f4hnam1_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ryf06f4hnam1_API, "mod_ryf06f4hnam1._C_API", NULL);
