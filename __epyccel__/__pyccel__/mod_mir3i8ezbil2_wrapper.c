...
#define MOD_MIR3I8EZBIL2_WRAPPER

#include "mod_mir3i8ezbil2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_mir3i8ezbil2_methods[] = {
    {
...
static struct PyModuleDef mod_mir3i8ezbil2_module = {
    ...
    0,
    mod_mir3i8ezbil2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_mir3i8ezbil2(void)
{
    PyObject* mod;
    static void* Pymod_mir3i8ezbil2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_mir3i8ezbil2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_mir3i8ezbil2_API, "mod_mir3i8ezbil2._C_API", NULL);
