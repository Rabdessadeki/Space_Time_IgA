...
#define MOD_1NU11IUG6PHP_WRAPPER

#include "mod_1nu11iug6php_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1nu11iug6php_methods[] = {
    {
...
static struct PyModuleDef mod_1nu11iug6php_module = {
    ...
    0,
    mod_1nu11iug6php_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1nu11iug6php(void)
{
    PyObject* mod;
    static void* Pymod_1nu11iug6php_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1nu11iug6php_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1nu11iug6php_API, "mod_1nu11iug6php._C_API", NULL);
