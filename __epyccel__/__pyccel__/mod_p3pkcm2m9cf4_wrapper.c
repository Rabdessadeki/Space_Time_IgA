...
#define MOD_P3PKCM2M9CF4_WRAPPER

#include "mod_p3pkcm2m9cf4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_p3pkcm2m9cf4_methods[] = {
    {
...
static struct PyModuleDef mod_p3pkcm2m9cf4_module = {
    ...
    0,
    mod_p3pkcm2m9cf4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_p3pkcm2m9cf4(void)
{
    PyObject* mod;
    static void* Pymod_p3pkcm2m9cf4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_p3pkcm2m9cf4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_p3pkcm2m9cf4_API, "mod_p3pkcm2m9cf4._C_API", NULL);
