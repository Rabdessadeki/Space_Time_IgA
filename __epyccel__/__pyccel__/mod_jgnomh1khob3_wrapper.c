...
#define MOD_JGNOMH1KHOB3_WRAPPER

#include "mod_jgnomh1khob3_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_jgnomh1khob3_methods[] = {
    {
...
static struct PyModuleDef mod_jgnomh1khob3_module = {
    ...
    0,
    mod_jgnomh1khob3_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_jgnomh1khob3(void)
{
    PyObject* mod;
    static void* Pymod_jgnomh1khob3_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_jgnomh1khob3_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_jgnomh1khob3_API, "mod_jgnomh1khob3._C_API", NULL);
