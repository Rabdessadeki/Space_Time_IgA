...
#define MOD_91HQ5492ANNC_WRAPPER

#include "mod_91hq5492annc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_91hq5492annc_methods[] = {
    {
...
static struct PyModuleDef mod_91hq5492annc_module = {
    ...
    0,
    mod_91hq5492annc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_91hq5492annc(void)
{
    PyObject* mod;
    static void* Pymod_91hq5492annc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_91hq5492annc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_91hq5492annc_API, "mod_91hq5492annc._C_API", NULL);
