...
#define MOD_1I0E5K6QN1EA_WRAPPER

#include "mod_1i0e5k6qn1ea_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1i0e5k6qn1ea_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_1i0e5k6qn1ea_module = {
    ...
    0,
    mod_1i0e5k6qn1ea_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1i0e5k6qn1ea(void)
{
    PyObject* mod;
    static void* Pymod_1i0e5k6qn1ea_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1i0e5k6qn1ea_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1i0e5k6qn1ea_API, "mod_1i0e5k6qn1ea._C_API", NULL);
