...
#define MOD_F071RD88G4M4_WRAPPER

#include "mod_f071rd88g4m4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_f071rd88g4m4_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_f071rd88g4m4_module = {
    ...
    0,
    mod_f071rd88g4m4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_f071rd88g4m4(void)
{
    PyObject* mod;
    static void* Pymod_f071rd88g4m4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_f071rd88g4m4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_f071rd88g4m4_API, "mod_f071rd88g4m4._C_API", NULL);
