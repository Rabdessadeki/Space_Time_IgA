...
#define MOD_ZTTBM5P7XUHF_WRAPPER

#include "mod_zttbm5p7xuhf_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zttbm5p7xuhf_methods[] = {
    {
...
static struct PyModuleDef mod_zttbm5p7xuhf_module = {
    ...
    0,
    mod_zttbm5p7xuhf_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zttbm5p7xuhf(void)
{
    PyObject* mod;
    static void* Pymod_zttbm5p7xuhf_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zttbm5p7xuhf_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zttbm5p7xuhf_API, "mod_zttbm5p7xuhf._C_API", NULL);
