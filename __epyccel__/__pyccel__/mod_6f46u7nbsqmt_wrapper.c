...
#define MOD_6F46U7NBSQMT_WRAPPER

#include "mod_6f46u7nbsqmt_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6f46u7nbsqmt_methods[] = {
    {
...
static struct PyModuleDef mod_6f46u7nbsqmt_module = {
    ...
    0,
    mod_6f46u7nbsqmt_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6f46u7nbsqmt(void)
{
    PyObject* mod;
    static void* Pymod_6f46u7nbsqmt_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6f46u7nbsqmt_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6f46u7nbsqmt_API, "mod_6f46u7nbsqmt._C_API", NULL);
