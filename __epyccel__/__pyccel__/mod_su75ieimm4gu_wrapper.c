...
#define MOD_SU75IEIMM4GU_WRAPPER

#include "mod_su75ieimm4gu_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_su75ieimm4gu_methods[] = {
    {
...
static struct PyModuleDef mod_su75ieimm4gu_module = {
    ...
    0,
    mod_su75ieimm4gu_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_su75ieimm4gu(void)
{
    PyObject* mod;
    static void* Pymod_su75ieimm4gu_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_su75ieimm4gu_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_su75ieimm4gu_API, "mod_su75ieimm4gu._C_API", NULL);
