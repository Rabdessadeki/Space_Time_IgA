...
#define MOD_RMQJ2BSG86P5_WRAPPER

#include "mod_rmqj2bsg86p5_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_rmqj2bsg86p5_methods[] = {
    {
...
static struct PyModuleDef mod_rmqj2bsg86p5_module = {
    ...
    0,
    mod_rmqj2bsg86p5_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_rmqj2bsg86p5(void)
{
    PyObject* mod;
    static void* Pymod_rmqj2bsg86p5_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_rmqj2bsg86p5_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_rmqj2bsg86p5_API, "mod_rmqj2bsg86p5._C_API", NULL);
