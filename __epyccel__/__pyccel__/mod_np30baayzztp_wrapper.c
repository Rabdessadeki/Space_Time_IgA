...
#define MOD_NP30BAAYZZTP_WRAPPER

#include "mod_np30baayzztp_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_np30baayzztp_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_np30baayzztp_module = {
    ...
    0,
    mod_np30baayzztp_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_np30baayzztp(void)
{
    PyObject* mod;
    static void* Pymod_np30baayzztp_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_np30baayzztp_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_np30baayzztp_API, "mod_np30baayzztp._C_API", NULL);
