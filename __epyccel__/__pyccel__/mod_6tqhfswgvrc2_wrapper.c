...
#define MOD_6TQHFSWGVRC2_WRAPPER

#include "mod_6tqhfswgvrc2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6tqhfswgvrc2_methods[] = {
    {
...
static struct PyModuleDef mod_6tqhfswgvrc2_module = {
    ...
    0,
    mod_6tqhfswgvrc2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6tqhfswgvrc2(void)
{
    PyObject* mod;
    static void* Pymod_6tqhfswgvrc2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6tqhfswgvrc2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6tqhfswgvrc2_API, "mod_6tqhfswgvrc2._C_API", NULL);
