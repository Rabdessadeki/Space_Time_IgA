...
#define MOD_3DGGI8XKJJ8K_WRAPPER

#include "mod_3dggi8xkjj8k_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_3dggi8xkjj8k_methods[] = {
    {
...
static struct PyModuleDef mod_3dggi8xkjj8k_module = {
    ...
    0,
    mod_3dggi8xkjj8k_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_3dggi8xkjj8k(void)
{
    PyObject* mod;
    static void* Pymod_3dggi8xkjj8k_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_3dggi8xkjj8k_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_3dggi8xkjj8k_API, "mod_3dggi8xkjj8k._C_API", NULL);
