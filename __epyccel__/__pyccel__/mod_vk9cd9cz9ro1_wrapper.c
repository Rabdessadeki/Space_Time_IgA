...
#define MOD_VK9CD9CZ9RO1_WRAPPER

#include "mod_vk9cd9cz9ro1_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_vk9cd9cz9ro1_methods[] = {
    {
...
static struct PyModuleDef mod_vk9cd9cz9ro1_module = {
    ...
    0,
    mod_vk9cd9cz9ro1_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vk9cd9cz9ro1(void)
{
    PyObject* mod;
    static void* Pymod_vk9cd9cz9ro1_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_vk9cd9cz9ro1_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_vk9cd9cz9ro1_API, "mod_vk9cd9cz9ro1._C_API", NULL);
