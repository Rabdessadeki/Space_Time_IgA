...
#define MOD_A7GHU6SURODV_WRAPPER

#include "mod_a7ghu6surodv_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_a7ghu6surodv_methods[] = {
    {
...
static struct PyModuleDef mod_a7ghu6surodv_module = {
    ...
    0,
    mod_a7ghu6surodv_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_a7ghu6surodv(void)
{
    PyObject* mod;
    static void* Pymod_a7ghu6surodv_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_a7ghu6surodv_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_a7ghu6surodv_API, "mod_a7ghu6surodv._C_API", NULL);
