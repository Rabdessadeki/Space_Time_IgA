...
#define MOD_8E6I85OT750A_WRAPPER

#include "mod_8e6i85ot750a_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_8e6i85ot750a_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_8e6i85ot750a_module = {
    ...
    0,
    mod_8e6i85ot750a_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_8e6i85ot750a(void)
{
    PyObject* mod;
    static void* Pymod_8e6i85ot750a_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_8e6i85ot750a_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_8e6i85ot750a_API, "mod_8e6i85ot750a._C_API", NULL);
