...
#define MOD_5E9SQ9Y0CJDE_WRAPPER

#include "mod_5e9sq9y0cjde_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_5e9sq9y0cjde_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_5e9sq9y0cjde_module = {
    ...
    0,
    mod_5e9sq9y0cjde_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_5e9sq9y0cjde(void)
{
    PyObject* mod;
    static void* Pymod_5e9sq9y0cjde_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_5e9sq9y0cjde_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_5e9sq9y0cjde_API, "mod_5e9sq9y0cjde._C_API", NULL);
