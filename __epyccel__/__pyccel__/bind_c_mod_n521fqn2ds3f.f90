module bind_c_mod_n521fqn2ds3f

  use mod_n521fqn2ds3f

  use, intrinsic :: ISO_C_Binding, only : f64 => C_DOUBLE , c_ptr , &
        C_F_Pointer , i64 => C_INT64_T
  implicit none
...
end module bind_c_mod_n521fqn2ds3f
