...
#define MOD_1X8PHPG0IZ5R_WRAPPER

#include "mod_1x8phpg0iz5r_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1x8phpg0iz5r_methods[] = {
    {
...
static struct PyModuleDef mod_1x8phpg0iz5r_module = {
    ...
    0,
    mod_1x8phpg0iz5r_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1x8phpg0iz5r(void)
{
    PyObject* mod;
    static void* Pymod_1x8phpg0iz5r_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1x8phpg0iz5r_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1x8phpg0iz5r_API, "mod_1x8phpg0iz5r._C_API", NULL);
