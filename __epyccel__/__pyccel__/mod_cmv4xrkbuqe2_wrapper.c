...
#define MOD_CMV4XRKBUQE2_WRAPPER

#include "mod_cmv4xrkbuqe2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_cmv4xrkbuqe2_methods[] = {
    {
...
static struct PyModuleDef mod_cmv4xrkbuqe2_module = {
    ...
    0,
    mod_cmv4xrkbuqe2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_cmv4xrkbuqe2(void)
{
    PyObject* mod;
    static void* Pymod_cmv4xrkbuqe2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_cmv4xrkbuqe2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_cmv4xrkbuqe2_API, "mod_cmv4xrkbuqe2._C_API", NULL);
