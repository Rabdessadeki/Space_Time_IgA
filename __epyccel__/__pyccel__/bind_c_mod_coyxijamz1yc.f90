module bind_c_mod_coyxijamz1yc

  use mod_coyxijamz1yc
  ...
  subroutine bind_c_assemble_matrix_un_ex01(ne1, ne2, p1, p2, &
        ...
        bound_points_2_stride_1, bound_points_2_stride_2, bound_matrix, &
    ...
    call assemble_matrix_un_ex01(ne1 = ne1, ne2 = ne2, p1 = p1, p2 = p2, &
          ...
          bound_points_2_stride_1), matrix = matrix(1_i64:: &
...
end module bind_c_mod_coyxijamz1yc
