...
#define MOD_XJANS5C0I1WL_WRAPPER

#include "mod_xjans5c0i1wl_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_xjans5c0i1wl_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_xjans5c0i1wl_module = {
    ...
    0,
    mod_xjans5c0i1wl_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xjans5c0i1wl(void)
{
    PyObject* mod;
    static void* Pymod_xjans5c0i1wl_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_xjans5c0i1wl_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_xjans5c0i1wl_API, "mod_xjans5c0i1wl._C_API", NULL);
