...
#define MOD_VKP6I0YWDKGN_WRAPPER

#include "mod_vkp6i0ywdkgn_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_vkp6i0ywdkgn_methods[] = {
    {
...
static struct PyModuleDef mod_vkp6i0ywdkgn_module = {
    ...
    0,
    mod_vkp6i0ywdkgn_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vkp6i0ywdkgn(void)
{
    PyObject* mod;
    static void* Pymod_vkp6i0ywdkgn_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_vkp6i0ywdkgn_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_vkp6i0ywdkgn_API, "mod_vkp6i0ywdkgn._C_API", NULL);
