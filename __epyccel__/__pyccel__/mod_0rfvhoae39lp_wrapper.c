...
#define MOD_0RFVHOAE39LP_WRAPPER

#include "mod_0rfvhoae39lp_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_0rfvhoae39lp_methods[] = {
    {
...
static struct PyModuleDef mod_0rfvhoae39lp_module = {
    ...
    0,
    mod_0rfvhoae39lp_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_0rfvhoae39lp(void)
{
    PyObject* mod;
    static void* Pymod_0rfvhoae39lp_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_0rfvhoae39lp_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_0rfvhoae39lp_API, "mod_0rfvhoae39lp._C_API", NULL);
