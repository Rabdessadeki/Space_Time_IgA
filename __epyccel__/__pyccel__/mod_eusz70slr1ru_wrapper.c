...
#define MOD_EUSZ70SLR1RU_WRAPPER

#include "mod_eusz70slr1ru_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_eusz70slr1ru_methods[] = {
    {
...
static struct PyModuleDef mod_eusz70slr1ru_module = {
    ...
    0,
    mod_eusz70slr1ru_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_eusz70slr1ru(void)
{
    PyObject* mod;
    static void* Pymod_eusz70slr1ru_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_eusz70slr1ru_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_eusz70slr1ru_API, "mod_eusz70slr1ru._C_API", NULL);
