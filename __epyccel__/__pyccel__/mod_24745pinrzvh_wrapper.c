...
#define MOD_24745PINRZVH_WRAPPER

#include "mod_24745pinrzvh_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_24745pinrzvh_methods[] = {
    {
...
static struct PyModuleDef mod_24745pinrzvh_module = {
    ...
    0,
    mod_24745pinrzvh_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_24745pinrzvh(void)
{
    PyObject* mod;
    static void* Pymod_24745pinrzvh_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_24745pinrzvh_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_24745pinrzvh_API, "mod_24745pinrzvh._C_API", NULL);
