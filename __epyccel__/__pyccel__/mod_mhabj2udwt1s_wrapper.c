...
#define MOD_MHABJ2UDWT1S_WRAPPER

#include "mod_mhabj2udwt1s_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_mhabj2udwt1s_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_mhabj2udwt1s_module = {
    ...
    0,
    mod_mhabj2udwt1s_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_mhabj2udwt1s(void)
{
    PyObject* mod;
    static void* Pymod_mhabj2udwt1s_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_mhabj2udwt1s_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_mhabj2udwt1s_API, "mod_mhabj2udwt1s._C_API", NULL);
