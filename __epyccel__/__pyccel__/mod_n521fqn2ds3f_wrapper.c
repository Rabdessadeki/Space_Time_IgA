...
#define MOD_N521FQN2DS3F_WRAPPER

#include "mod_n521fqn2ds3f_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_n521fqn2ds3f_methods[] = {
    {
...
static struct PyModuleDef mod_n521fqn2ds3f_module = {
    ...
    0,
    mod_n521fqn2ds3f_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_n521fqn2ds3f(void)
{
    PyObject* mod;
    static void* Pymod_n521fqn2ds3f_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_n521fqn2ds3f_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_n521fqn2ds3f_API, "mod_n521fqn2ds3f._C_API", NULL);
