...
#define MOD_E4V6W4WCXP2H_WRAPPER

#include "mod_e4v6w4wcxp2h_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_e4v6w4wcxp2h_methods[] = {
    {
...
static struct PyModuleDef mod_e4v6w4wcxp2h_module = {
    ...
    0,
    mod_e4v6w4wcxp2h_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_e4v6w4wcxp2h(void)
{
    PyObject* mod;
    static void* Pymod_e4v6w4wcxp2h_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_e4v6w4wcxp2h_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_e4v6w4wcxp2h_API, "mod_e4v6w4wcxp2h._C_API", NULL);
