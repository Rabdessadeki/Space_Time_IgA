...
#define MOD_DAV68IXNSTCR_WRAPPER

#include "mod_dav68ixnstcr_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dav68ixnstcr_methods[] = {
    {
...
static struct PyModuleDef mod_dav68ixnstcr_module = {
    ...
    0,
    mod_dav68ixnstcr_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dav68ixnstcr(void)
{
    PyObject* mod;
    static void* Pymod_dav68ixnstcr_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dav68ixnstcr_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dav68ixnstcr_API, "mod_dav68ixnstcr._C_API", NULL);
