...
#define MOD_NSG9Z0UWZTJE_WRAPPER

#include "mod_nsg9z0uwztje_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_nsg9z0uwztje_methods[] = {
    {
...
static struct PyModuleDef mod_nsg9z0uwztje_module = {
    ...
    0,
    mod_nsg9z0uwztje_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_nsg9z0uwztje(void)
{
    PyObject* mod;
    static void* Pymod_nsg9z0uwztje_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_nsg9z0uwztje_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_nsg9z0uwztje_API, "mod_nsg9z0uwztje._C_API", NULL);
