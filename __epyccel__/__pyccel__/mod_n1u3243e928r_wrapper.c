...
#define MOD_N1U3243E928R_WRAPPER

#include "mod_n1u3243e928r_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_n1u3243e928r_methods[] = {
    {
...
static struct PyModuleDef mod_n1u3243e928r_module = {
    ...
    0,
    mod_n1u3243e928r_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_n1u3243e928r(void)
{
    PyObject* mod;
    static void* Pymod_n1u3243e928r_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_n1u3243e928r_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_n1u3243e928r_API, "mod_n1u3243e928r._C_API", NULL);
