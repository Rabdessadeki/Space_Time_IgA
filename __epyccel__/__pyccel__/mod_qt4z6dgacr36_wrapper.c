...
#define MOD_QT4Z6DGACR36_WRAPPER

#include "mod_qt4z6dgacr36_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_qt4z6dgacr36_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_qt4z6dgacr36_module = {
    ...
    0,
    mod_qt4z6dgacr36_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_qt4z6dgacr36(void)
{
    PyObject* mod;
    static void* Pymod_qt4z6dgacr36_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_qt4z6dgacr36_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_qt4z6dgacr36_API, "mod_qt4z6dgacr36._C_API", NULL);
