...
#define MOD_ZUHXZJJF3EBC_WRAPPER

#include "mod_zuhxzjjf3ebc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zuhxzjjf3ebc_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_zuhxzjjf3ebc_module = {
    ...
    0,
    mod_zuhxzjjf3ebc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zuhxzjjf3ebc(void)
{
    PyObject* mod;
    static void* Pymod_zuhxzjjf3ebc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zuhxzjjf3ebc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zuhxzjjf3ebc_API, "mod_zuhxzjjf3ebc._C_API", NULL);
