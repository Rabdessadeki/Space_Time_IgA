...
#define MOD_1YWDXKQKGXMI_WRAPPER

#include "mod_1ywdxkqkgxmi_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1ywdxkqkgxmi_methods[] = {
    {
...
static struct PyModuleDef mod_1ywdxkqkgxmi_module = {
    ...
    0,
    mod_1ywdxkqkgxmi_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1ywdxkqkgxmi(void)
{
    PyObject* mod;
    static void* Pymod_1ywdxkqkgxmi_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1ywdxkqkgxmi_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1ywdxkqkgxmi_API, "mod_1ywdxkqkgxmi._C_API", NULL);
