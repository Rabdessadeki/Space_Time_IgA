module bind_c_mod_hkd1pcv4m4b3

  use mod_hkd1pcv4m4b3

  use, intrinsic :: ISO_C_Binding, only : c_ptr , i64 => C_INT64_T , &
        C_F_Pointer , f64 => C_DOUBLE
  implicit none

  contains

  !........................................
  subroutine bind_c_assemble_vector_un_ex01_without_ddm(ne1, ne2, p1, p2 &
        ...
        bound_vector_d, bound_vector_d_shape_1, bound_vector_d_shape_2, &
        bound_vector_d_stride_1, bound_vector_d_stride_2, bound_rhs, &
    ...
    call assemble_vector_un_ex01_without_ddm(ne1 = ne1, ne2 = ne2, p1 = &
          p1, p2 = p2, spans_1 = spans_1(1_i64::bound_spans_1_stride_1) &
          , spans_2 = spans_2(1_i64::bound_spans_2_stride_1), basis_1 = &
          basis_1(1_i64::bound_basis_1_stride_4, 1_i64:: &
          bound_basis_1_stride_3, 1_i64::bound_basis_1_stride_2, 1_i64 &
          ::bound_basis_1_stride_1), basis_2 = basis_2(1_i64:: &
          bound_basis_2_stride_4, 1_i64::bound_basis_2_stride_3, 1_i64 &
          ::bound_basis_2_stride_2, 1_i64::bound_basis_2_stride_1), &
          ...
          points_1 = points_1(1_i64::bound_points_1_stride_2, 1_i64:: &
          bound_points_1_stride_1), points_2 = points_2(1_i64:: &
          bound_points_2_stride_2, 1_i64::bound_points_2_stride_1), &
          vector_m1 = vector_m1(1_i64::bound_vector_m1_stride_2, 1_i64 &
          ::bound_vector_m1_stride_1), vector_m2 = vector_m2(1_i64:: &
          bound_vector_m2_stride_2, 1_i64::bound_vector_m2_stride_1), &
          vector_d = vector_d(1_i64::bound_vector_d_stride_2, 1_i64:: &
          bound_vector_d_stride_1), rhs = rhs(1_i64::bound_rhs_stride_2 &
          , 1_i64::bound_rhs_stride_1))

  end subroutine bind_c_assemble_vector_un_ex01_without_ddm
  !........................................

end module bind_c_mod_hkd1pcv4m4b3
