...
#define MOD_X4NVOV5FUZM2_WRAPPER

#include "mod_x4nvov5fuzm2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_x4nvov5fuzm2_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_x4nvov5fuzm2_module = {
    ...
    0,
    mod_x4nvov5fuzm2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_x4nvov5fuzm2(void)
{
    PyObject* mod;
    static void* Pymod_x4nvov5fuzm2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_x4nvov5fuzm2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_x4nvov5fuzm2_API, "mod_x4nvov5fuzm2._C_API", NULL);
