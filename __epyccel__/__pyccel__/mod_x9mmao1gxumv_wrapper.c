...
#define MOD_X9MMAO1GXUMV_WRAPPER

#include "mod_x9mmao1gxumv_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_x9mmao1gxumv_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_x9mmao1gxumv_module = {
    ...
    0,
    mod_x9mmao1gxumv_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_x9mmao1gxumv(void)
{
    PyObject* mod;
    static void* Pymod_x9mmao1gxumv_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_x9mmao1gxumv_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_x9mmao1gxumv_API, "mod_x9mmao1gxumv._C_API", NULL);
