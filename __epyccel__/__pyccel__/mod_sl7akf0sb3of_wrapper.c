...
#define MOD_SL7AKF0SB3OF_WRAPPER

#include "mod_sl7akf0sb3of_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_sl7akf0sb3of_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_sl7akf0sb3of_module = {
    ...
    0,
    mod_sl7akf0sb3of_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_sl7akf0sb3of(void)
{
    PyObject* mod;
    static void* Pymod_sl7akf0sb3of_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_sl7akf0sb3of_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_sl7akf0sb3of_API, "mod_sl7akf0sb3of._C_API", NULL);
