...
#define MOD_DOA39JMQDW0Y_WRAPPER

#include "mod_doa39jmqdw0y_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_doa39jmqdw0y_methods[] = {
    {
...
static struct PyModuleDef mod_doa39jmqdw0y_module = {
    ...
    0,
    mod_doa39jmqdw0y_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_doa39jmqdw0y(void)
{
    PyObject* mod;
    static void* Pymod_doa39jmqdw0y_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_doa39jmqdw0y_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_doa39jmqdw0y_API, "mod_doa39jmqdw0y._C_API", NULL);
