...
#define MOD_FFJ3W5CJ7ECY_WRAPPER

#include "mod_ffj3w5cj7ecy_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ffj3w5cj7ecy_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_ffj3w5cj7ecy_module = {
    ...
    0,
    mod_ffj3w5cj7ecy_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ffj3w5cj7ecy(void)
{
    PyObject* mod;
    static void* Pymod_ffj3w5cj7ecy_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ffj3w5cj7ecy_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ffj3w5cj7ecy_API, "mod_ffj3w5cj7ecy._C_API", NULL);
