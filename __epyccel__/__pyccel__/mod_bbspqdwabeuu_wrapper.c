...
#define MOD_BBSPQDWABEUU_WRAPPER

#include "mod_bbspqdwabeuu_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_bbspqdwabeuu_methods[] = {
    {
...
static struct PyModuleDef mod_bbspqdwabeuu_module = {
    ...
    0,
    mod_bbspqdwabeuu_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_bbspqdwabeuu(void)
{
    PyObject* mod;
    static void* Pymod_bbspqdwabeuu_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_bbspqdwabeuu_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_bbspqdwabeuu_API, "mod_bbspqdwabeuu._C_API", NULL);
