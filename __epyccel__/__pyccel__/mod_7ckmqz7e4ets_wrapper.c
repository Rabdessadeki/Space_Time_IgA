...
#define MOD_7CKMQZ7E4ETS_WRAPPER

#include "mod_7ckmqz7e4ets_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_7ckmqz7e4ets_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_7ckmqz7e4ets_module = {
    ...
    0,
    mod_7ckmqz7e4ets_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_7ckmqz7e4ets(void)
{
    PyObject* mod;
    static void* Pymod_7ckmqz7e4ets_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_7ckmqz7e4ets_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_7ckmqz7e4ets_API, "mod_7ckmqz7e4ets._C_API", NULL);
