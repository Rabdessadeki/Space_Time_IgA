...
#define MOD_DTC4XVSSCGBL_WRAPPER

#include "mod_dtc4xvsscgbl_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dtc4xvsscgbl_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_dtc4xvsscgbl_module = {
    ...
    0,
    mod_dtc4xvsscgbl_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dtc4xvsscgbl(void)
{
    PyObject* mod;
    static void* Pymod_dtc4xvsscgbl_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dtc4xvsscgbl_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dtc4xvsscgbl_API, "mod_dtc4xvsscgbl._C_API", NULL);
