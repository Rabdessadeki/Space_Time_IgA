...
#define MOD_LQEUHJGJR0W6_WRAPPER

#include "mod_lqeuhjgjr0w6_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lqeuhjgjr0w6_methods[] = {
    {
...
static struct PyModuleDef mod_lqeuhjgjr0w6_module = {
    ...
    0,
    mod_lqeuhjgjr0w6_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lqeuhjgjr0w6(void)
{
    PyObject* mod;
    static void* Pymod_lqeuhjgjr0w6_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lqeuhjgjr0w6_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lqeuhjgjr0w6_API, "mod_lqeuhjgjr0w6._C_API", NULL);
