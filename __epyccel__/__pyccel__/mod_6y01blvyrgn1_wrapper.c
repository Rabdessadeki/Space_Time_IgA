...
#define MOD_6Y01BLVYRGN1_WRAPPER

#include "mod_6y01blvyrgn1_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6y01blvyrgn1_methods[] = {
    {
...
static struct PyModuleDef mod_6y01blvyrgn1_module = {
    ...
    0,
    mod_6y01blvyrgn1_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6y01blvyrgn1(void)
{
    PyObject* mod;
    static void* Pymod_6y01blvyrgn1_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6y01blvyrgn1_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6y01blvyrgn1_API, "mod_6y01blvyrgn1._C_API", NULL);
