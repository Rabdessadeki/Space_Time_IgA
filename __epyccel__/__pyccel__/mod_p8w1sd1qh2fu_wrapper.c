...
#define MOD_P8W1SD1QH2FU_WRAPPER

#include "mod_p8w1sd1qh2fu_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_p8w1sd1qh2fu_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_p8w1sd1qh2fu_module = {
    ...
    0,
    mod_p8w1sd1qh2fu_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_p8w1sd1qh2fu(void)
{
    PyObject* mod;
    static void* Pymod_p8w1sd1qh2fu_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_p8w1sd1qh2fu_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_p8w1sd1qh2fu_API, "mod_p8w1sd1qh2fu._C_API", NULL);
