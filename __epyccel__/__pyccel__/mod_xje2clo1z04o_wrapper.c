...
#define MOD_XJE2CLO1Z04O_WRAPPER

#include "mod_xje2clo1z04o_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_xje2clo1z04o_methods[] = {
    {
...
static struct PyModuleDef mod_xje2clo1z04o_module = {
    ...
    0,
    mod_xje2clo1z04o_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xje2clo1z04o(void)
{
    PyObject* mod;
    static void* Pymod_xje2clo1z04o_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_xje2clo1z04o_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_xje2clo1z04o_API, "mod_xje2clo1z04o._C_API", NULL);
