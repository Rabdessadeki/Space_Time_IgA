...
#define MOD_6PFSJ0PVT029_WRAPPER

#include "mod_6pfsj0pvt029_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6pfsj0pvt029_methods[] = {
    {
...
static struct PyModuleDef mod_6pfsj0pvt029_module = {
    ...
    0,
    mod_6pfsj0pvt029_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6pfsj0pvt029(void)
{
    PyObject* mod;
    static void* Pymod_6pfsj0pvt029_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6pfsj0pvt029_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6pfsj0pvt029_API, "mod_6pfsj0pvt029._C_API", NULL);
