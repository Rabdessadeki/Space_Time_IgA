...
#define MOD_NQR68J9BUIOD_WRAPPER

#include "mod_nqr68j9buiod_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_nqr68j9buiod_methods[] = {
    {
...
static struct PyModuleDef mod_nqr68j9buiod_module = {
    ...
    0,
    mod_nqr68j9buiod_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_nqr68j9buiod(void)
{
    PyObject* mod;
    static void* Pymod_nqr68j9buiod_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_nqr68j9buiod_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_nqr68j9buiod_API, "mod_nqr68j9buiod._C_API", NULL);
