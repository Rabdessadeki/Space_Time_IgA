...
#define MOD_4FCS21S7914S_WRAPPER

#include "mod_4fcs21s7914s_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_4fcs21s7914s_methods[] = {
    {
...
static struct PyModuleDef mod_4fcs21s7914s_module = {
    ...
    0,
    mod_4fcs21s7914s_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_4fcs21s7914s(void)
{
    PyObject* mod;
    static void* Pymod_4fcs21s7914s_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_4fcs21s7914s_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_4fcs21s7914s_API, "mod_4fcs21s7914s._C_API", NULL);
