...
#define MOD_KQA967284IXW_WRAPPER

#include "mod_kqa967284ixw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_kqa967284ixw_methods[] = {
    {
...
static struct PyModuleDef mod_kqa967284ixw_module = {
    ...
    0,
    mod_kqa967284ixw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_kqa967284ixw(void)
{
    PyObject* mod;
    static void* Pymod_kqa967284ixw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_kqa967284ixw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_kqa967284ixw_API, "mod_kqa967284ixw._C_API", NULL);
