...
#define MOD_I6LMRN1ZQLBW_WRAPPER

#include "mod_i6lmrn1zqlbw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_i6lmrn1zqlbw_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_i6lmrn1zqlbw_module = {
    ...
    0,
    mod_i6lmrn1zqlbw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_i6lmrn1zqlbw(void)
{
    PyObject* mod;
    static void* Pymod_i6lmrn1zqlbw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_i6lmrn1zqlbw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_i6lmrn1zqlbw_API, "mod_i6lmrn1zqlbw._C_API", NULL);
