...
#define MOD_D08WIYW2CAKW_WRAPPER

#include "mod_d08wiyw2cakw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_d08wiyw2cakw_methods[] = {
    {
...
static struct PyModuleDef mod_d08wiyw2cakw_module = {
    ...
    0,
    mod_d08wiyw2cakw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_d08wiyw2cakw(void)
{
    PyObject* mod;
    static void* Pymod_d08wiyw2cakw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_d08wiyw2cakw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_d08wiyw2cakw_API, "mod_d08wiyw2cakw._C_API", NULL);
