...
#define MOD_KM2NN0PBD3FS_WRAPPER

#include "mod_km2nn0pbd3fs_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_km2nn0pbd3fs_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_km2nn0pbd3fs_module = {
    ...
    0,
    mod_km2nn0pbd3fs_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_km2nn0pbd3fs(void)
{
    PyObject* mod;
    static void* Pymod_km2nn0pbd3fs_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_km2nn0pbd3fs_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_km2nn0pbd3fs_API, "mod_km2nn0pbd3fs._C_API", NULL);
