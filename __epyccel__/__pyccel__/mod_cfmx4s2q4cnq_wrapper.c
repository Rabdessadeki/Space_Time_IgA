...
#define MOD_CFMX4S2Q4CNQ_WRAPPER

#include "mod_cfmx4s2q4cnq_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_cfmx4s2q4cnq_methods[] = {
    {
...
static struct PyModuleDef mod_cfmx4s2q4cnq_module = {
    ...
    0,
    mod_cfmx4s2q4cnq_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_cfmx4s2q4cnq(void)
{
    PyObject* mod;
    static void* Pymod_cfmx4s2q4cnq_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_cfmx4s2q4cnq_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_cfmx4s2q4cnq_API, "mod_cfmx4s2q4cnq._C_API", NULL);
