...
#define MOD_5LFQ3W3DBGBS_WRAPPER

#include "mod_5lfq3w3dbgbs_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_5lfq3w3dbgbs_methods[] = {
    {
...
static struct PyModuleDef mod_5lfq3w3dbgbs_module = {
    ...
    0,
    mod_5lfq3w3dbgbs_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_5lfq3w3dbgbs(void)
{
    PyObject* mod;
    static void* Pymod_5lfq3w3dbgbs_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_5lfq3w3dbgbs_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_5lfq3w3dbgbs_API, "mod_5lfq3w3dbgbs._C_API", NULL);
