...
#define MOD_XWF3TXU7TIBU_WRAPPER

#include "mod_xwf3txu7tibu_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_xwf3txu7tibu_methods[] = {
    {
...
static struct PyModuleDef mod_xwf3txu7tibu_module = {
    ...
    0,
    mod_xwf3txu7tibu_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xwf3txu7tibu(void)
{
    PyObject* mod;
    static void* Pymod_xwf3txu7tibu_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_xwf3txu7tibu_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_xwf3txu7tibu_API, "mod_xwf3txu7tibu._C_API", NULL);
