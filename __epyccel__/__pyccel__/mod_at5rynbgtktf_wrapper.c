...
#define MOD_AT5RYNBGTKTF_WRAPPER

#include "mod_at5rynbgtktf_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_at5rynbgtktf_methods[] = {
    {
...
static struct PyModuleDef mod_at5rynbgtktf_module = {
    ...
    0,
    mod_at5rynbgtktf_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_at5rynbgtktf(void)
{
    PyObject* mod;
    static void* Pymod_at5rynbgtktf_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_at5rynbgtktf_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_at5rynbgtktf_API, "mod_at5rynbgtktf._C_API", NULL);
