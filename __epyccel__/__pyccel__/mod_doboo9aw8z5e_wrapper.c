...
#define MOD_DOBOO9AW8Z5E_WRAPPER

#include "mod_doboo9aw8z5e_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyObject* bind_c_assemble_norm_ex01_wrapper(PyObject* self, PyObject* args, PyObject* kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOOOOOOOOOOO", kwlist, &ne1_obj, &ne2_obj, &p1_obj, &p2_obj, &spans_1_obj, &spans_2_obj, &basis_1_obj, &basis_2_obj, &weights_1_obj, &weights_2_obj, &points_1_obj, &points_2_obj, &vector_u_obj, &rhs_obj))
    {
        return NULL;
    }
...
static PyMethodDef mod_doboo9aw8z5e_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_doboo9aw8z5e_module = {
    ...
    0,
    mod_doboo9aw8z5e_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_doboo9aw8z5e(void)
{
    PyObject* mod;
    static void* Pymod_doboo9aw8z5e_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_doboo9aw8z5e_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_doboo9aw8z5e_API, "mod_doboo9aw8z5e._C_API", NULL);
