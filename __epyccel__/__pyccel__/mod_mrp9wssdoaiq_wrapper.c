...
#define MOD_MRP9WSSDOAIQ_WRAPPER

#include "mod_mrp9wssdoaiq_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_mrp9wssdoaiq_methods[] = {
    {
...
static struct PyModuleDef mod_mrp9wssdoaiq_module = {
    ...
    0,
    mod_mrp9wssdoaiq_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_mrp9wssdoaiq(void)
{
    PyObject* mod;
    static void* Pymod_mrp9wssdoaiq_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_mrp9wssdoaiq_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_mrp9wssdoaiq_API, "mod_mrp9wssdoaiq._C_API", NULL);
