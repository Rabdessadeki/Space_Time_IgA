...
#define MOD_MP3QGRQXUJAT_WRAPPER

#include "mod_mp3qgrqxujat_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_mp3qgrqxujat_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_mp3qgrqxujat_module = {
    ...
    0,
    mod_mp3qgrqxujat_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_mp3qgrqxujat(void)
{
    PyObject* mod;
    static void* Pymod_mp3qgrqxujat_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_mp3qgrqxujat_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_mp3qgrqxujat_API, "mod_mp3qgrqxujat._C_API", NULL);
