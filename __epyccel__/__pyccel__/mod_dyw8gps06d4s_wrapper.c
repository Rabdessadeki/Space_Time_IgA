...
#define MOD_DYW8GPS06D4S_WRAPPER

#include "mod_dyw8gps06d4s_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dyw8gps06d4s_methods[] = {
    {
...
static struct PyModuleDef mod_dyw8gps06d4s_module = {
    ...
    0,
    mod_dyw8gps06d4s_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dyw8gps06d4s(void)
{
    PyObject* mod;
    static void* Pymod_dyw8gps06d4s_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dyw8gps06d4s_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dyw8gps06d4s_API, "mod_dyw8gps06d4s._C_API", NULL);
