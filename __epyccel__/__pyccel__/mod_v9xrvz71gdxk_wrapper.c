...
#define MOD_V9XRVZ71GDXK_WRAPPER

#include "mod_v9xrvz71gdxk_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_v9xrvz71gdxk_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_v9xrvz71gdxk_module = {
    ...
    0,
    mod_v9xrvz71gdxk_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_v9xrvz71gdxk(void)
{
    PyObject* mod;
    static void* Pymod_v9xrvz71gdxk_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_v9xrvz71gdxk_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_v9xrvz71gdxk_API, "mod_v9xrvz71gdxk._C_API", NULL);
