...
#define MOD_URUWB4EZLT5M_WRAPPER

#include "mod_uruwb4ezlt5m_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_uruwb4ezlt5m_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_uruwb4ezlt5m_module = {
    ...
    0,
    mod_uruwb4ezlt5m_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_uruwb4ezlt5m(void)
{
    PyObject* mod;
    static void* Pymod_uruwb4ezlt5m_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_uruwb4ezlt5m_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_uruwb4ezlt5m_API, "mod_uruwb4ezlt5m._C_API", NULL);
