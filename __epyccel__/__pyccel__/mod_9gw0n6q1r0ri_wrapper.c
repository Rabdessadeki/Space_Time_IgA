...
#define MOD_9GW0N6Q1R0RI_WRAPPER

#include "mod_9gw0n6q1r0ri_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_9gw0n6q1r0ri_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_9gw0n6q1r0ri_module = {
    ...
    0,
    mod_9gw0n6q1r0ri_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9gw0n6q1r0ri(void)
{
    PyObject* mod;
    static void* Pymod_9gw0n6q1r0ri_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_9gw0n6q1r0ri_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_9gw0n6q1r0ri_API, "mod_9gw0n6q1r0ri._C_API", NULL);
