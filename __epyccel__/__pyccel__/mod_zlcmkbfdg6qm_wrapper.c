...
#define MOD_ZLCMKBFDG6QM_WRAPPER

#include "mod_zlcmkbfdg6qm_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zlcmkbfdg6qm_methods[] = {
    {
...
static struct PyModuleDef mod_zlcmkbfdg6qm_module = {
    ...
    0,
    mod_zlcmkbfdg6qm_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zlcmkbfdg6qm(void)
{
    PyObject* mod;
    static void* Pymod_zlcmkbfdg6qm_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zlcmkbfdg6qm_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zlcmkbfdg6qm_API, "mod_zlcmkbfdg6qm._C_API", NULL);
