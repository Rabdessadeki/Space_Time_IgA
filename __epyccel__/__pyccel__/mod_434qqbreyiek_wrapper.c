...
#define MOD_434QQBREYIEK_WRAPPER

#include "mod_434qqbreyiek_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_434qqbreyiek_methods[] = {
    {
...
static struct PyModuleDef mod_434qqbreyiek_module = {
    ...
    0,
    mod_434qqbreyiek_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_434qqbreyiek(void)
{
    PyObject* mod;
    static void* Pymod_434qqbreyiek_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_434qqbreyiek_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_434qqbreyiek_API, "mod_434qqbreyiek._C_API", NULL);
