...
#define MOD_XEUT65TDX7GS_WRAPPER

#include "mod_xeut65tdx7gs_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_xeut65tdx7gs_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_xeut65tdx7gs_module = {
    ...
    0,
    mod_xeut65tdx7gs_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xeut65tdx7gs(void)
{
    PyObject* mod;
    static void* Pymod_xeut65tdx7gs_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_xeut65tdx7gs_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_xeut65tdx7gs_API, "mod_xeut65tdx7gs._C_API", NULL);
