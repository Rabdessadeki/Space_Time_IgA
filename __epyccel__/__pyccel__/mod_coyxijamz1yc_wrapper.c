...
#define MOD_COYXIJAMZ1YC_WRAPPER

#include "mod_coyxijamz1yc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyObject* bind_c_assemble_matrix_un_ex01_wrapper(PyObject* self, PyObject* args, PyObject* kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOOOOOOOOOO", kwlist, &ne1_obj, &ne2_obj, &p1_obj, &p2_obj, &spans_1_obj, &spans_2_obj, &basis_1_obj, &basis_2_obj, &weights_1_obj, &weights_2_obj, &points_1_obj, &points_2_obj, &matrix_obj))
    {
        return NULL;
    }
...
static PyMethodDef mod_coyxijamz1yc_methods[] = {
    {
...
static struct PyModuleDef mod_coyxijamz1yc_module = {
    ...
    0,
    mod_coyxijamz1yc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_coyxijamz1yc(void)
{
    PyObject* mod;
    static void* Pymod_coyxijamz1yc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_coyxijamz1yc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_coyxijamz1yc_API, "mod_coyxijamz1yc._C_API", NULL);
