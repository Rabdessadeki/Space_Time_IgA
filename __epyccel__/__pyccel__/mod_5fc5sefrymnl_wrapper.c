...
#define MOD_5FC5SEFRYMNL_WRAPPER

#include "mod_5fc5sefrymnl_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_5fc5sefrymnl_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_5fc5sefrymnl_module = {
    ...
    0,
    mod_5fc5sefrymnl_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_5fc5sefrymnl(void)
{
    PyObject* mod;
    static void* Pymod_5fc5sefrymnl_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_5fc5sefrymnl_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_5fc5sefrymnl_API, "mod_5fc5sefrymnl._C_API", NULL);
