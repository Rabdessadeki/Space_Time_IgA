...
#define MOD_PJ9SNNX6CD1D_WRAPPER

#include "mod_pj9snnx6cd1d_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_pj9snnx6cd1d_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_pj9snnx6cd1d_module = {
    ...
    0,
    mod_pj9snnx6cd1d_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_pj9snnx6cd1d(void)
{
    PyObject* mod;
    static void* Pymod_pj9snnx6cd1d_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_pj9snnx6cd1d_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_pj9snnx6cd1d_API, "mod_pj9snnx6cd1d._C_API", NULL);
