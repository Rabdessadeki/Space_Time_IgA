      ...
      do ie2 = 0_i64, ne2 - 1_i64
        ...
        do g1 = 0_i64, k1 - 1_i64
          do g2 = 0_i64, k2 - 1_i64
            ...
            sy = lvalues_uy(g2, g1)
            !... Test 0
            f = sin(2.0_f64 * 3.141592653589793_f64 * x) * sin(2.0_f64 * &
                  3.141592653589793_f64 * y)
            fx = 2.0_f64 * 3.141592653589793_f64 * cos(2.0_f64 * &
                  3.141592653589793_f64 * x) * sin(2.0_f64 * &
                  3.141592653589793_f64 * y)
            fy = 2.0_f64 * 3.141592653589793_f64 * sin(2.0_f64 * &
                  3.141592653589793_f64 * x) * cos(2.0_f64 * &
                  3.141592653589793_f64 * y)
            !... Test 1
            !f    = x*sin(pi*y)
            !fx   = sin(pi*y)
