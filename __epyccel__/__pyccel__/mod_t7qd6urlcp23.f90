      ...
      do ie2 = 0_i64, ne2 - 1_i64
        ...
        do g1 = 0_i64, k1 - 1_i64
          do g2 = 0_i64, k2 - 1_i64
            ...
            !... Test 1
            f = x * sin(3.141592653589793_f64 * y)
            fx = sin(3.141592653589793_f64 * y)
            fy = 3.141592653589793_f64 * x * cos(3.141592653589793_f64 * &
                  y)
            !... Test 2
            !f =  x**2*y*(1 - y)
            !fx=  2*x*y*(1 - y)
