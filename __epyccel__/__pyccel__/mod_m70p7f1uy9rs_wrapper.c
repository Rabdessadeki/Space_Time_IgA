...
#define MOD_M70P7F1UY9RS_WRAPPER

#include "mod_m70p7f1uy9rs_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_m70p7f1uy9rs_methods[] = {
    {
...
static struct PyModuleDef mod_m70p7f1uy9rs_module = {
    ...
    0,
    mod_m70p7f1uy9rs_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_m70p7f1uy9rs(void)
{
    PyObject* mod;
    static void* Pymod_m70p7f1uy9rs_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_m70p7f1uy9rs_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_m70p7f1uy9rs_API, "mod_m70p7f1uy9rs._C_API", NULL);
