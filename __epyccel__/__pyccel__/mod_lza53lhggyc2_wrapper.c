...
#define MOD_LZA53LHGGYC2_WRAPPER

#include "mod_lza53lhggyc2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lza53lhggyc2_methods[] = {
    {
...
static struct PyModuleDef mod_lza53lhggyc2_module = {
    ...
    0,
    mod_lza53lhggyc2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lza53lhggyc2(void)
{
    PyObject* mod;
    static void* Pymod_lza53lhggyc2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lza53lhggyc2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lza53lhggyc2_API, "mod_lza53lhggyc2._C_API", NULL);
