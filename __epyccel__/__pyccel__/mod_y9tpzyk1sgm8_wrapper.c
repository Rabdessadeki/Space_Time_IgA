...
#define MOD_Y9TPZYK1SGM8_WRAPPER

#include "mod_y9tpzyk1sgm8_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_y9tpzyk1sgm8_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_y9tpzyk1sgm8_module = {
    ...
    0,
    mod_y9tpzyk1sgm8_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_y9tpzyk1sgm8(void)
{
    PyObject* mod;
    static void* Pymod_y9tpzyk1sgm8_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_y9tpzyk1sgm8_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_y9tpzyk1sgm8_API, "mod_y9tpzyk1sgm8._C_API", NULL);
