...
#define MOD_1HMWRSK2EAKW_WRAPPER

#include "mod_1hmwrsk2eakw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1hmwrsk2eakw_methods[] = {
    {
...
static struct PyModuleDef mod_1hmwrsk2eakw_module = {
    ...
    0,
    mod_1hmwrsk2eakw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1hmwrsk2eakw(void)
{
    PyObject* mod;
    static void* Pymod_1hmwrsk2eakw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1hmwrsk2eakw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1hmwrsk2eakw_API, "mod_1hmwrsk2eakw._C_API", NULL);
