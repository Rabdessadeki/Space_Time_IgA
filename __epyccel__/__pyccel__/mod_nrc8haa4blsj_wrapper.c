...
#define MOD_NRC8HAA4BLSJ_WRAPPER

#include "mod_nrc8haa4blsj_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_nrc8haa4blsj_methods[] = {
    {
...
static struct PyModuleDef mod_nrc8haa4blsj_module = {
    ...
    0,
    mod_nrc8haa4blsj_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_nrc8haa4blsj(void)
{
    PyObject* mod;
    static void* Pymod_nrc8haa4blsj_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_nrc8haa4blsj_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_nrc8haa4blsj_API, "mod_nrc8haa4blsj._C_API", NULL);
