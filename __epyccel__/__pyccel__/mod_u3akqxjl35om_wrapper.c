...
#define MOD_U3AKQXJL35OM_WRAPPER

#include "mod_u3akqxjl35om_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_u3akqxjl35om_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_u3akqxjl35om_module = {
    ...
    0,
    mod_u3akqxjl35om_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_u3akqxjl35om(void)
{
    PyObject* mod;
    static void* Pymod_u3akqxjl35om_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_u3akqxjl35om_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_u3akqxjl35om_API, "mod_u3akqxjl35om._C_API", NULL);
