...
#define MOD_L3V8OPFFZ7GI_WRAPPER

#include "mod_l3v8opffz7gi_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_l3v8opffz7gi_methods[] = {
    {
...
static struct PyModuleDef mod_l3v8opffz7gi_module = {
    ...
    0,
    mod_l3v8opffz7gi_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_l3v8opffz7gi(void)
{
    PyObject* mod;
    static void* Pymod_l3v8opffz7gi_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_l3v8opffz7gi_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_l3v8opffz7gi_API, "mod_l3v8opffz7gi._C_API", NULL);
