...
#define MOD_TSFM6I50K2CF_WRAPPER

#include "mod_tsfm6i50k2cf_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_tsfm6i50k2cf_methods[] = {
    {
...
static struct PyModuleDef mod_tsfm6i50k2cf_module = {
    ...
    0,
    mod_tsfm6i50k2cf_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tsfm6i50k2cf(void)
{
    PyObject* mod;
    static void* Pymod_tsfm6i50k2cf_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_tsfm6i50k2cf_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_tsfm6i50k2cf_API, "mod_tsfm6i50k2cf._C_API", NULL);
