...
#define MOD_HKD1PCV4M4B3_WRAPPER

#include "mod_hkd1pcv4m4b3_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_hkd1pcv4m4b3_methods[] = {
    {
...
static struct PyModuleDef mod_hkd1pcv4m4b3_module = {
    ...
    0,
    mod_hkd1pcv4m4b3_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hkd1pcv4m4b3(void)
{
    PyObject* mod;
    static void* Pymod_hkd1pcv4m4b3_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_hkd1pcv4m4b3_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_hkd1pcv4m4b3_API, "mod_hkd1pcv4m4b3._C_API", NULL);
