...
#define MOD_FMT5DX6VN14P_WRAPPER

#include "mod_fmt5dx6vn14p_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_fmt5dx6vn14p_methods[] = {
    {
...
static struct PyModuleDef mod_fmt5dx6vn14p_module = {
    ...
    0,
    mod_fmt5dx6vn14p_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_fmt5dx6vn14p(void)
{
    PyObject* mod;
    static void* Pymod_fmt5dx6vn14p_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_fmt5dx6vn14p_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_fmt5dx6vn14p_API, "mod_fmt5dx6vn14p._C_API", NULL);
