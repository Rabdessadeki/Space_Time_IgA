...
#define MOD_SHAC7XMON942_WRAPPER

#include "mod_shac7xmon942_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_shac7xmon942_methods[] = {
    {
...
static struct PyModuleDef mod_shac7xmon942_module = {
    ...
    0,
    mod_shac7xmon942_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_shac7xmon942(void)
{
    PyObject* mod;
    static void* Pymod_shac7xmon942_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_shac7xmon942_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_shac7xmon942_API, "mod_shac7xmon942._C_API", NULL);
