...
#define MOD_9ZNJSDR0GZTW_WRAPPER

#include "mod_9znjsdr0gztw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_9znjsdr0gztw_methods[] = {
    {
...
static struct PyModuleDef mod_9znjsdr0gztw_module = {
    ...
    0,
    mod_9znjsdr0gztw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9znjsdr0gztw(void)
{
    PyObject* mod;
    static void* Pymod_9znjsdr0gztw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_9znjsdr0gztw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_9znjsdr0gztw_API, "mod_9znjsdr0gztw._C_API", NULL);
