...
#define MOD_70EMQQIO9DNF_WRAPPER

#include "mod_70emqqio9dnf_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_70emqqio9dnf_methods[] = {
    {
...
static struct PyModuleDef mod_70emqqio9dnf_module = {
    ...
    0,
    mod_70emqqio9dnf_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_70emqqio9dnf(void)
{
    PyObject* mod;
    static void* Pymod_70emqqio9dnf_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_70emqqio9dnf_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_70emqqio9dnf_API, "mod_70emqqio9dnf._C_API", NULL);
