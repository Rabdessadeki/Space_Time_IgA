...
#define MOD_GMCZZVH9U4QE_WRAPPER

#include "mod_gmczzvh9u4qe_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_gmczzvh9u4qe_methods[] = {
    {
...
static struct PyModuleDef mod_gmczzvh9u4qe_module = {
    ...
    0,
    mod_gmczzvh9u4qe_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_gmczzvh9u4qe(void)
{
    PyObject* mod;
    static void* Pymod_gmczzvh9u4qe_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_gmczzvh9u4qe_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_gmczzvh9u4qe_API, "mod_gmczzvh9u4qe._C_API", NULL);
