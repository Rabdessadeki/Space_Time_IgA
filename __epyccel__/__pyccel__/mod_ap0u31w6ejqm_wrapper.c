...
#define MOD_AP0U31W6EJQM_WRAPPER

#include "mod_ap0u31w6ejqm_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ap0u31w6ejqm_methods[] = {
    {
...
static struct PyModuleDef mod_ap0u31w6ejqm_module = {
    ...
    0,
    mod_ap0u31w6ejqm_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ap0u31w6ejqm(void)
{
    PyObject* mod;
    static void* Pymod_ap0u31w6ejqm_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ap0u31w6ejqm_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ap0u31w6ejqm_API, "mod_ap0u31w6ejqm._C_API", NULL);
