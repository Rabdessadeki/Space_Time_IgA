...
#define MOD_ITNK3DWIC4SX_WRAPPER

#include "mod_itnk3dwic4sx_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_itnk3dwic4sx_methods[] = {
    {
...
static struct PyModuleDef mod_itnk3dwic4sx_module = {
    ...
    0,
    mod_itnk3dwic4sx_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_itnk3dwic4sx(void)
{
    PyObject* mod;
    static void* Pymod_itnk3dwic4sx_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_itnk3dwic4sx_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_itnk3dwic4sx_API, "mod_itnk3dwic4sx._C_API", NULL);
