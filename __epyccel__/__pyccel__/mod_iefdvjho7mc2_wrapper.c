...
#define MOD_IEFDVJHO7MC2_WRAPPER

#include "mod_iefdvjho7mc2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_iefdvjho7mc2_methods[] = {
    {
...
static struct PyModuleDef mod_iefdvjho7mc2_module = {
    ...
    0,
    mod_iefdvjho7mc2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_iefdvjho7mc2(void)
{
    PyObject* mod;
    static void* Pymod_iefdvjho7mc2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_iefdvjho7mc2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_iefdvjho7mc2_API, "mod_iefdvjho7mc2._C_API", NULL);
