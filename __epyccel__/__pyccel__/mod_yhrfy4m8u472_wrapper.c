...
#define MOD_YHRFY4M8U472_WRAPPER

#include "mod_yhrfy4m8u472_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_yhrfy4m8u472_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_yhrfy4m8u472_module = {
    ...
    0,
    mod_yhrfy4m8u472_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_yhrfy4m8u472(void)
{
    PyObject* mod;
    static void* Pymod_yhrfy4m8u472_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_yhrfy4m8u472_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_yhrfy4m8u472_API, "mod_yhrfy4m8u472._C_API", NULL);
