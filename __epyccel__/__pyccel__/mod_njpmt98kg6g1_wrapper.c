...
#define MOD_NJPMT98KG6G1_WRAPPER

#include "mod_njpmt98kg6g1_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_njpmt98kg6g1_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_njpmt98kg6g1_module = {
    ...
    0,
    mod_njpmt98kg6g1_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_njpmt98kg6g1(void)
{
    PyObject* mod;
    static void* Pymod_njpmt98kg6g1_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_njpmt98kg6g1_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_njpmt98kg6g1_API, "mod_njpmt98kg6g1._C_API", NULL);
