...
#define MOD_91MEDSJ2W10U_WRAPPER

#include "mod_91medsj2w10u_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_91medsj2w10u_methods[] = {
    {
...
static struct PyModuleDef mod_91medsj2w10u_module = {
    ...
    0,
    mod_91medsj2w10u_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_91medsj2w10u(void)
{
    PyObject* mod;
    static void* Pymod_91medsj2w10u_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_91medsj2w10u_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_91medsj2w10u_API, "mod_91medsj2w10u._C_API", NULL);
