...
#define MOD_D01HE1K42OO8_WRAPPER

#include "mod_d01he1k42oo8_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_d01he1k42oo8_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_d01he1k42oo8_module = {
    ...
    0,
    mod_d01he1k42oo8_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_d01he1k42oo8(void)
{
    PyObject* mod;
    static void* Pymod_d01he1k42oo8_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_d01he1k42oo8_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_d01he1k42oo8_API, "mod_d01he1k42oo8._C_API", NULL);
