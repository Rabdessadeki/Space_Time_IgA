...
#define MOD_GCOOVEQOABXD_WRAPPER

#include "mod_gcooveqoabxd_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_gcooveqoabxd_methods[] = {
    {
...
static struct PyModuleDef mod_gcooveqoabxd_module = {
    ...
    0,
    mod_gcooveqoabxd_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_gcooveqoabxd(void)
{
    PyObject* mod;
    static void* Pymod_gcooveqoabxd_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_gcooveqoabxd_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_gcooveqoabxd_API, "mod_gcooveqoabxd._C_API", NULL);
