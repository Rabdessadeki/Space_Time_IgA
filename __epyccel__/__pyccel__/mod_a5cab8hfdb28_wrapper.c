...
#define MOD_A5CAB8HFDB28_WRAPPER

#include "mod_a5cab8hfdb28_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_a5cab8hfdb28_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_a5cab8hfdb28_module = {
    ...
    0,
    mod_a5cab8hfdb28_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_a5cab8hfdb28(void)
{
    PyObject* mod;
    static void* Pymod_a5cab8hfdb28_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_a5cab8hfdb28_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_a5cab8hfdb28_API, "mod_a5cab8hfdb28._C_API", NULL);
