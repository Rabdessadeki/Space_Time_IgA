...
#define MOD_X1LU36SVEELO_WRAPPER

#include "mod_x1lu36sveelo_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_x1lu36sveelo_methods[] = {
    {
...
static struct PyModuleDef mod_x1lu36sveelo_module = {
    ...
    0,
    mod_x1lu36sveelo_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_x1lu36sveelo(void)
{
    PyObject* mod;
    static void* Pymod_x1lu36sveelo_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_x1lu36sveelo_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_x1lu36sveelo_API, "mod_x1lu36sveelo._C_API", NULL);
