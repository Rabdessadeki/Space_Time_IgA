...
#define MOD_B5XIF0WV7H4R_WRAPPER

#include "mod_b5xif0wv7h4r_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_b5xif0wv7h4r_methods[] = {
    {
...
static struct PyModuleDef mod_b5xif0wv7h4r_module = {
    ...
    0,
    mod_b5xif0wv7h4r_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_b5xif0wv7h4r(void)
{
    PyObject* mod;
    static void* Pymod_b5xif0wv7h4r_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_b5xif0wv7h4r_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_b5xif0wv7h4r_API, "mod_b5xif0wv7h4r._C_API", NULL);
