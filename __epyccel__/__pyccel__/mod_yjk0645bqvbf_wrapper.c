...
#define MOD_YJK0645BQVBF_WRAPPER

#include "mod_yjk0645bqvbf_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_yjk0645bqvbf_methods[] = {
    {
...
static struct PyModuleDef mod_yjk0645bqvbf_module = {
    ...
    0,
    mod_yjk0645bqvbf_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_yjk0645bqvbf(void)
{
    PyObject* mod;
    static void* Pymod_yjk0645bqvbf_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_yjk0645bqvbf_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_yjk0645bqvbf_API, "mod_yjk0645bqvbf._C_API", NULL);
