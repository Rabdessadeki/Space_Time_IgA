...
#define MOD_XNHXLWNWHCBL_WRAPPER

#include "mod_xnhxlwnwhcbl_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_xnhxlwnwhcbl_methods[] = {
    {
...
static struct PyModuleDef mod_xnhxlwnwhcbl_module = {
    ...
    0,
    mod_xnhxlwnwhcbl_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xnhxlwnwhcbl(void)
{
    PyObject* mod;
    static void* Pymod_xnhxlwnwhcbl_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_xnhxlwnwhcbl_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_xnhxlwnwhcbl_API, "mod_xnhxlwnwhcbl._C_API", NULL);
