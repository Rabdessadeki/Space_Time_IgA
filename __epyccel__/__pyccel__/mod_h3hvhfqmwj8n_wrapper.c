...
#define MOD_H3HVHFQMWJ8N_WRAPPER

#include "mod_h3hvhfqmwj8n_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_h3hvhfqmwj8n_methods[] = {
    {
...
static struct PyModuleDef mod_h3hvhfqmwj8n_module = {
    ...
    0,
    mod_h3hvhfqmwj8n_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_h3hvhfqmwj8n(void)
{
    PyObject* mod;
    static void* Pymod_h3hvhfqmwj8n_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_h3hvhfqmwj8n_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_h3hvhfqmwj8n_API, "mod_h3hvhfqmwj8n._C_API", NULL);
