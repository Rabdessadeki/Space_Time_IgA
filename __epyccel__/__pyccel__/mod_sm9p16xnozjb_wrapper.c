...
#define MOD_SM9P16XNOZJB_WRAPPER

#include "mod_sm9p16xnozjb_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_sm9p16xnozjb_methods[] = {
    {
...
static struct PyModuleDef mod_sm9p16xnozjb_module = {
    ...
    0,
    mod_sm9p16xnozjb_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_sm9p16xnozjb(void)
{
    PyObject* mod;
    static void* Pymod_sm9p16xnozjb_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_sm9p16xnozjb_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_sm9p16xnozjb_API, "mod_sm9p16xnozjb._C_API", NULL);
