...
#define MOD_1CH64CA3704T_WRAPPER

#include "mod_1ch64ca3704t_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1ch64ca3704t_methods[] = {
    {
...
static struct PyModuleDef mod_1ch64ca3704t_module = {
    ...
    0,
    mod_1ch64ca3704t_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1ch64ca3704t(void)
{
    PyObject* mod;
    static void* Pymod_1ch64ca3704t_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1ch64ca3704t_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1ch64ca3704t_API, "mod_1ch64ca3704t._C_API", NULL);
