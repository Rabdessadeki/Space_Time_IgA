...
#define MOD_SFOSKRUWPQ8Z_WRAPPER

#include "mod_sfoskruwpq8z_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_sfoskruwpq8z_methods[] = {
    {
...
static struct PyModuleDef mod_sfoskruwpq8z_module = {
    ...
    0,
    mod_sfoskruwpq8z_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_sfoskruwpq8z(void)
{
    PyObject* mod;
    static void* Pymod_sfoskruwpq8z_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_sfoskruwpq8z_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_sfoskruwpq8z_API, "mod_sfoskruwpq8z._C_API", NULL);
