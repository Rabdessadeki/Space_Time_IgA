...
#define MOD_FZ4RS9SM1JKZ_WRAPPER

#include "mod_fz4rs9sm1jkz_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_fz4rs9sm1jkz_methods[] = {
    {
...
static struct PyModuleDef mod_fz4rs9sm1jkz_module = {
    ...
    0,
    mod_fz4rs9sm1jkz_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_fz4rs9sm1jkz(void)
{
    PyObject* mod;
    static void* Pymod_fz4rs9sm1jkz_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_fz4rs9sm1jkz_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_fz4rs9sm1jkz_API, "mod_fz4rs9sm1jkz._C_API", NULL);
