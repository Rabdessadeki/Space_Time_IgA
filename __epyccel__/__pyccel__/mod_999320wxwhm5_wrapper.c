...
#define MOD_999320WXWHM5_WRAPPER

#include "mod_999320wxwhm5_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_999320wxwhm5_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_999320wxwhm5_module = {
    ...
    0,
    mod_999320wxwhm5_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_999320wxwhm5(void)
{
    PyObject* mod;
    static void* Pymod_999320wxwhm5_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_999320wxwhm5_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_999320wxwhm5_API, "mod_999320wxwhm5._C_API", NULL);
