...
#define MOD_ZKAK96YBCO1L_WRAPPER

#include "mod_zkak96ybco1l_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zkak96ybco1l_methods[] = {
    {
...
static struct PyModuleDef mod_zkak96ybco1l_module = {
    ...
    0,
    mod_zkak96ybco1l_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zkak96ybco1l(void)
{
    PyObject* mod;
    static void* Pymod_zkak96ybco1l_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zkak96ybco1l_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zkak96ybco1l_API, "mod_zkak96ybco1l._C_API", NULL);
