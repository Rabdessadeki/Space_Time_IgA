...
#define MOD_XC3NA2FW9ZOX_WRAPPER

#include "mod_xc3na2fw9zox_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_xc3na2fw9zox_methods[] = {
    {
...
static struct PyModuleDef mod_xc3na2fw9zox_module = {
    ...
    0,
    mod_xc3na2fw9zox_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xc3na2fw9zox(void)
{
    PyObject* mod;
    static void* Pymod_xc3na2fw9zox_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_xc3na2fw9zox_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_xc3na2fw9zox_API, "mod_xc3na2fw9zox._C_API", NULL);
