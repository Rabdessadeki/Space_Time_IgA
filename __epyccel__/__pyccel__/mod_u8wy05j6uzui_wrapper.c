...
#define MOD_U8WY05J6UZUI_WRAPPER

#include "mod_u8wy05j6uzui_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_u8wy05j6uzui_methods[] = {
    {
...
static struct PyModuleDef mod_u8wy05j6uzui_module = {
    ...
    0,
    mod_u8wy05j6uzui_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_u8wy05j6uzui(void)
{
    PyObject* mod;
    static void* Pymod_u8wy05j6uzui_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_u8wy05j6uzui_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_u8wy05j6uzui_API, "mod_u8wy05j6uzui._C_API", NULL);
