...
#define MOD_UZZWSLJJ01BR_WRAPPER

#include "mod_uzzwsljj01br_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_uzzwsljj01br_methods[] = {
    {
...
static struct PyModuleDef mod_uzzwsljj01br_module = {
    ...
    0,
    mod_uzzwsljj01br_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_uzzwsljj01br(void)
{
    PyObject* mod;
    static void* Pymod_uzzwsljj01br_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_uzzwsljj01br_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_uzzwsljj01br_API, "mod_uzzwsljj01br._C_API", NULL);
