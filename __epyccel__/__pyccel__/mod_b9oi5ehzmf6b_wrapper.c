...
#define MOD_B9OI5EHZMF6B_WRAPPER

#include "mod_b9oi5ehzmf6b_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyObject* bind_c_assemble_vector_ex01_wrapper(PyObject* self, PyObject* args, PyObject* kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOOOOOOOOOOO", kwlist, &ne1_obj, &ne2_obj, &p1_obj, &p2_obj, &spans_1_obj, &spans_2_obj, &basis_1_obj, &basis_2_obj, &weights_1_obj, &weights_2_obj, &points_1_obj, &points_2_obj, &vector_d_obj, &rhs_obj))
    {
        return NULL;
    }
...
static PyMethodDef mod_b9oi5ehzmf6b_methods[] = {
    {
...
static struct PyModuleDef mod_b9oi5ehzmf6b_module = {
    ...
    0,
    mod_b9oi5ehzmf6b_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_b9oi5ehzmf6b(void)
{
    PyObject* mod;
    static void* Pymod_b9oi5ehzmf6b_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_b9oi5ehzmf6b_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_b9oi5ehzmf6b_API, "mod_b9oi5ehzmf6b._C_API", NULL);
