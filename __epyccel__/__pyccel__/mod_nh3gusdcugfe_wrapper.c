...
#define MOD_NH3GUSDCUGFE_WRAPPER

#include "mod_nh3gusdcugfe_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_nh3gusdcugfe_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_nh3gusdcugfe_module = {
    ...
    0,
    mod_nh3gusdcugfe_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_nh3gusdcugfe(void)
{
    PyObject* mod;
    static void* Pymod_nh3gusdcugfe_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_nh3gusdcugfe_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_nh3gusdcugfe_API, "mod_nh3gusdcugfe._C_API", NULL);
