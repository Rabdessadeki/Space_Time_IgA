...
#define MOD_T7QD6URLCP23_WRAPPER

#include "mod_t7qd6urlcp23_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_t7qd6urlcp23_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_t7qd6urlcp23_module = {
    ...
    0,
    mod_t7qd6urlcp23_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_t7qd6urlcp23(void)
{
    PyObject* mod;
    static void* Pymod_t7qd6urlcp23_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_t7qd6urlcp23_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_t7qd6urlcp23_API, "mod_t7qd6urlcp23._C_API", NULL);
