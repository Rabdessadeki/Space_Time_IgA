...
#define MOD_EHUXJFYODSAF_WRAPPER

#include "mod_ehuxjfyodsaf_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ehuxjfyodsaf_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_ehuxjfyodsaf_module = {
    ...
    0,
    mod_ehuxjfyodsaf_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ehuxjfyodsaf(void)
{
    PyObject* mod;
    static void* Pymod_ehuxjfyodsaf_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ehuxjfyodsaf_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ehuxjfyodsaf_API, "mod_ehuxjfyodsaf._C_API", NULL);
