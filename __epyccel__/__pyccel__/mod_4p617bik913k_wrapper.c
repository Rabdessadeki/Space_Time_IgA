...
#define MOD_4P617BIK913K_WRAPPER

#include "mod_4p617bik913k_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_4p617bik913k_methods[] = {
    {
...
static struct PyModuleDef mod_4p617bik913k_module = {
    ...
    0,
    mod_4p617bik913k_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_4p617bik913k(void)
{
    PyObject* mod;
    static void* Pymod_4p617bik913k_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_4p617bik913k_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_4p617bik913k_API, "mod_4p617bik913k._C_API", NULL);
